          ...
          <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-[#a0c58a]">
            ...
            <div className="flex flex-col items-start gap-4">
              ...
              <div className="flex flex-col gap-3">
                <a href="#home" className="text-white hover:text-[#d5ebc6] transition-colors font-medium text-sm">Home</a>
                <a href="#about" className="text-white hover:text-[#d5ebc6] transition-colors font-medium text-sm">About</a>
                <a href="#products" className="text-white hover:text-[#d5ebc6] transition-colors font-medium text-sm">Products</a>
                <a href="#contact" className="text-white hover:text-[#d5ebc6] transition-colors font-medium text-sm">Contact</a>
              </div>
            </div>
